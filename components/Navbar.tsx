        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className="hidden sm:block bg-fuchsia-500 hover:bg-fuchsia-600 text-white text-sm font-semibold px-5 py-2.5 rounded-full transition"
            >
              Join Free
            </a>
            ...
            >
              ...
              <div className="p-4 border-t border-zinc-800">
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() => setMobileMenuOpen(false)}
                  className="flex items-center justify-center gap-2 w-full bg-fuchsia-500 hover:bg-fuchsia-600 text-white font-bold px-4 py-4 rounded-xl transition"
                >
