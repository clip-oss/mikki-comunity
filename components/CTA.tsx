  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        ...
        >
          <JoinButton className="inline-flex items-center gap-3 bg-fuchsia-500 hover:bg-fuchsia-600 text-white font-bold px-10 py-5 rounded-full text-xl transition transform hover:scale-105 shadow-lg shadow-fuchsia-500/25">
